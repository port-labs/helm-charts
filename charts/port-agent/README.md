...
| `env.normal.VERBOSE_LOGGING`                         | Control logging verbosity. `"true"`: logs full message bodies and API responses. `"false"`: logs only metadata (status codes, IDs, offsets) | `"true"`                                                                                                                                                                                                                       |
