...
| `deleteDependents`                      | Deprecated. Will be used only for installation / migration from older versions, configure this from the ui. A flag to enable deletion of dependent Port Entities.       | `false`                               |
...
| `imageOsDetectionEnabled`               | If `true`, enables container image OS detection and adds `.imageOsInfo` to K8s object entities.                                                                         | `false`                               |
| `imageOsDetectionConcurrency`           | Maximum number of concurrent image OS detections.                                                                                                                       | `10`                                  |
