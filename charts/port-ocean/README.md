...
| `hostAliases`                                    | Extra `/etc/hosts` entries applied to all workloads (Deployment, CronJob, live-events, actions processor).                                                                                                                                                                                                                                                                                                                                                                                         | `[]`                        |
...
| `liveEvents.isRedisStreamConsumerEnabled` | When true, consume live events from Redis Streams (`OCEAN__LIVE_EVENTS__IS_REDIS_STREAM_CONSUMER_ENABLED`). Set on the live-events worker ConfigMap when `liveEvents.worker.enabled=true`, otherwise on the main Deployment. Not applied to CronJob or incremental workloads.                                                                                                                                                                                                                                                                              | `false`                     |
