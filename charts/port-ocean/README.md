...
| `liveEvents.isRedisStreamConsumerEnabled` | When true, the live-events worker consumes events from Redis Streams (`OCEAN__LIVE_EVENTS__IS_REDIS_STREAM_CONSUMER_ENABLED`)                                                                                                                                                                                                                                                                                                                                                                                                                              | `false`                     |
